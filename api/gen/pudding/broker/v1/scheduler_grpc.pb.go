...
const (
	SchedulerService_SendDelayMessage_FullMethodName = "/pudding.broker.v1.SchedulerService/SendDelayMessage"
)
...
func (c *schedulerServiceClient) SendDelayMessage(ctx context.Context, in *SendDelayMessageRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, SchedulerService_SendDelayMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SchedulerService_SendDelayMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SchedulerService_SendDelayMessage_FullMethodName,
	}
...
var SchedulerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pudding.broker.v1.SchedulerService",
	...
	Metadata: "pudding/broker/v1/scheduler.proto",
}
