...
type ProducerConfig struct {
	...
	// interval or until
	BatchingMaxPublishDelay uint `json:"batchingMaxPublishDelay" yaml:"batchingMaxPublishDelay"`
	...
	BatchingMaxMessages uint `json:"batchingMaxMessages" yaml:"batchingMaxMessages"`
	...
	BatchingMaxSize uint `json:"batchingMaxSize" yaml:"batchingMaxSize"`
}
